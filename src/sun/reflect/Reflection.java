...
public class Reflection {
    ...
    /**
     * 用于从公共视图中过滤某些类中的字段和方法，这些字段和方法是敏感的，或者它们可能包含vm内部对象。
     * 这些地图很少更新。我们不是在每次访问上同步，而是使用写时复制
     */
    //类的变量存储
    ...
    //本地方法,返回调用此方法的方法调用者的类，忽略与java.lang.reflect.Method.invoke()及其实现关联的帧。
    @CallerSensitive
